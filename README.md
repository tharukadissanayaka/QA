...
Applying different testing techniques (manual and automated).

Ensuring quality standards are met in terms of usability, performance, and security.
...
UI/UX Testing → Ensure smooth navigation and user-friendly design.

Performance Testing → Measure response time and scalability.
...
Testing Tools: Selenium, Jest, Mocha, Postman, JIRA 
