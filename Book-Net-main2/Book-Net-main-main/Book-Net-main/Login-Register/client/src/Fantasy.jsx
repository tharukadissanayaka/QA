...
function Fantasy() {
  ...
  // ✅ Fetch fantasy books from backend
  useEffect(() => {
    axios.get("http://localhost:3001/books?category=fantasy")
      .then(res => setFantasyBooks(res.data))
  ...
  return (
    <div className="home-container">
      <NavBar activePage="fantasy" />
      <section className="section">
        <h2>Fantasy Section</h2>
