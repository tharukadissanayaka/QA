...
function Romantic() {
  ...
  // ✅ Fetch romantic books from backend
  useEffect(() => {
    axios.get("http://localhost:3001/books?category=romantic")
      .then(res => setRomanticBooks(res.data))
  ...
  return (
    <div className="home-container">
      <NavBar activePage="romantic" />
      <section className="section">
        <h2>Romantic Section</h2>
        <div className="book-row">
          {romanticBooks.map((book, i) => (
